<div class="categoryDishes index">
	<h2><?php echo __('Category Dishes'); ?></h2>
	...
	<?php foreach ($categoryDishes as $categoryDish): ?>
	<tr>
		<td><?php echo h($categoryDish['CategoryDish']['id']); ?>&nbsp;</td>
		<td>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $categoryDish['CategoryDish']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $categoryDish['CategoryDish']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $categoryDish['CategoryDish']['id']), null, __('Are you sure you want to delete # %s?', $categoryDish['CategoryDish']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
