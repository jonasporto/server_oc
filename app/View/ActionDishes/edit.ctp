...
<?php echo $this->Form->create('ActionDish'); ?>
	<fieldset>
		<legend><?php echo __('Edit Action Dish'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('ActionDish.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('ActionDish.id'))); ?></li>
