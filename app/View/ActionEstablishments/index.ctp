<div class="actionEstablishments index">
	<h2><?php echo __('Action Establishments'); ?></h2>
	...
	<?php foreach ($actionEstablishments as $actionEstablishment): ?>
	<tr>
		<td><?php echo h($actionEstablishment['ActionEstablishment']['id']); ?>&nbsp;</td>
		<td>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $actionEstablishment['ActionEstablishment']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $actionEstablishment['ActionEstablishment']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $actionEstablishment['ActionEstablishment']['id']), null, __('Are you sure you want to delete # %s?', $actionEstablishment['ActionEstablishment']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
