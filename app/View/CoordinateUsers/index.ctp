<div class="coordinateUsers index">
	<h2><?php echo __('Coordinate Users'); ?></h2>
	...
	<?php foreach ($coordinateUsers as $coordinateUser): ?>
	<tr>
		<td><?php echo h($coordinateUser['CoordinateUser']['id']); ?>&nbsp;</td>
		<td>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $coordinateUser['CoordinateUser']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $coordinateUser['CoordinateUser']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $coordinateUser['CoordinateUser']['id']), null, __('Are you sure you want to delete # %s?', $coordinateUser['CoordinateUser']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
