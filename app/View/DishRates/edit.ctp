...
<?php echo $this->Form->create('DishRate'); ?>
	<fieldset>
		<legend><?php echo __('Edit Dish Rate'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('DishRate.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('DishRate.id'))); ?></li>
