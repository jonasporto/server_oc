<div class="coordinates index">
	...
	<tr>
		...
		<td><?php echo h($coordinate['Coordinate']['lng']); ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $coordinate['Coordinate']['id']), null, __('Are you sure you want to delete # %s?', $coordinate['Coordinate']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
